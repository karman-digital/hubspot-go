	...
	if resp.StatusCode != http.StatusOK {
		if resp.StatusCode == http.StatusBadRequest {
			...
			if errBody.Category == "VALIDATION_ERROR" {
				return ErrSubscriptionAlreadySubscribed
			} else {
...
func (c *credentials) SubscribeToCommunicationPreference(contactEmail string, subscriptionId int, legalOptions ...hubspotmodels.CommunicationLegalBasis) error {
